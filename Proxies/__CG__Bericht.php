 ...
 */
class Bericht extends \Bericht implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getBericht();
    }

    public function setBericht($Bericht)
    {
        $this->__load();
        return parent::setBericht($Bericht);
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'Datum', 'Onderwerp', 'Bericht', 'Verzender_id', 'Ontvanger_id');
    }
